    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (op.equals("APIInsereLivro")) {
                ...
                ComentarioDAO ldao = new ComentarioDAO();
                ArrayList<Comentario> encontrados = ldao.buscaLivrosPorTitulo(procurado);
                
                // preparar uma resposta da lista de livros em formato texto
                String msgComentario = "";
                for (Comentario comentario : encontrados) {
                    if (!msgComentario.equals("")) {
                        msgComentario += "|";
                    }
                    msgComentario += Comentario.getMensagem();
                }
                ...
                if (login.equals("eu") && (senha.equals("123456"))) {
